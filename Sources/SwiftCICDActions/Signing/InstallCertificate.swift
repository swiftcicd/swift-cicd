...
extension Signing {
    public struct InstallCertificate: Action {
        ...
        init(
            shouldCreateKeychain: Bool,
            keychain: String,
            keychainPassword: String,
            certificate: String,
            certificatePassword: String
        ) {
            self.shouldCreateKeychain = shouldCreateKeychain
        ...
        public init(
            ...
            let keychain = ContextValues.current.fileManager.temporaryDirectory.path/"temp.keychain"
