// https://github.com/apple/swift-tools-support-core/blob/main/Sources/TSCBasic/Lock.swift
...
public final class FileLock {
    ...
    public static func withLock<T>(fileToLock: AbsolutePath, lockFilesDirectory: AbsolutePath? = nil, type: LockType = .exclusive, body: () throws -> T) throws -> T {
        ...
        let lockFilesDirectory = try lockFilesDirectory ?? LocalFileSystem.shared.tempDirectory
        if !LocalFileSystem.shared.exists(lockFilesDirectory) {
            throw FileSystemError(.noEntry, lockFilesDirectory)
        }
        if !LocalFileSystem.shared.isDirectory(lockFilesDirectory) {
