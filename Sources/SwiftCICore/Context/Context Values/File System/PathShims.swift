// https://github.com/apple/swift-tools-support-core/blob/7c8bcf3eab7286855a2eb0cd0df103ea2761e259/Sources/TSCBasic/PathShims.swift
...
public func walk(
    _ path: AbsolutePath,
    fileSystem: FileSystem = LocalFileSystem.shared,
...
extension AbsolutePath {
    ...
    public func prettyPath(cwd: AbsolutePath? = LocalFileSystem.shared.currentWorkingDirectory) -> String {
